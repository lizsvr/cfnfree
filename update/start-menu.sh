...
is_root() {
    if [ 0 == $UID ]; then
        echo -e "${OK} ${GreenBG} The current user is the root user..${NC}"
        sleep 1
        echo -e "Getting Information...."
    else
        echo -e "${Error} ${RedBG} Please switch to the root user and execute start-menu again ${NC}"
        exit 1
    fi
}
is_root
...
clear
echo -e "$BLUE═════════════════════════════════════$NC"
echo -e "$BANRED           SELAMAT DATANG            $NC"
echo -e "$BLUE═════════════════════════════════════$NC"
figlet LIZSVR | lolcat
#echo -e "$NC"
echo -e "Telegram : @liz_mine"
echo -e "$BLUE═════════════════════════════════════$NC"
echo -e "$BANRED          Informasi System           $NC"
echo -e "$BLUE═════════════════════════════════════$NC"
...
echo -e "$CLAY Host : $host $NC"
echo -e "$CLAY CPU : $cpu $NC"
echo -e "$CLAY Kernel : $kernel $NC"
echo -e "$CLAY Up Time : $uptime $NC"
echo -e "$CLAY OS System : $ossys $NC"
echo -e "$CLAY Time Zone :$NC $timezone $NC"
echo -e "$CLAY Date :$NC $(date +%A) $(date +%CLAY-%d-%Y)"
echo -e "$CLAY Memory : $memory $NC"
echo -e "$BLUE═════════════════════════════════════$NC"
echo -e "$BANRED           Service Status            $NC"
echo -e "$BLUE═════════════════════════════════════$NC"
#
#
